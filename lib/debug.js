...
(function (module) {
    ...
    logger.notice = function () {
        winston.log("notice", formatMessage.apply(this, arguments));
    };
    ...
    logger.crit = function () {
        winston.log("crit", formatMessage.apply(this, arguments));
    };
    logger.alert = function () {
        winston.log("alert", formatMessage.apply(this, arguments));
    };
    logger.emerg = function () {
        winston.log("emerg", formatMessage.apply(this, arguments));
    };
