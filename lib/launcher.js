...
(function (module) {
    ...
    Launcher.prototype.start = function (listenPort, sslPort, sslKey, sslCert, cb) {
        ...
        return configLoader(globalConfig, function (err, properties) {
            ...
            logger.init({
                "aws-account-id":config["aws-account-id"],
                "aws-access-key-id":config["aws-access-key-id"],
                "aws-secret-access-key":config["aws-secret-access-key"],
                "aws-region":config["aws-region"],
                "aws-bucket":config["aws-bucket"],
                "measure-interval": config["measure-interval"],
